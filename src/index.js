...
function Square(props) {
  ...
  var renderSquare = function () {
    if (props.valueToDisplay === 'f') {
      return React.createElement('img', { src: 'https://cdn.rawgit.com/ofirdagan/build-your-own-react/2e8bad05/v5-examples/v5-step2-minesweeper/assets/black_flag.svg', width: '20', height: '20' });
    } else if (props.valueToDisplay === 'm') {
      return React.createElement('img', { src: 'https://cdn.rawgit.com/ofirdagan/build-your-own-react/2e8bad05/v5-examples/v5-step2-minesweeper/assets/bomb.svg', width: '20', height: '20' });
    } else {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('img', { src: 'https://cdn.rawgit.com/ofirdagan/build-your-own-react/2e8bad05/v5-examples/v5-step2-minesweeper/assets/black_flag.svg', width: '30', height: '30' })
        )
      ),
      React.createElement(
        'div',
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'property' },
          React.createElement('img', { src: 'https://cdn.rawgit.com/ofirdagan/build-your-own-react/2e8bad05/v5-examples/v5-step2-minesweeper/assets/arrowsLeftRight.svg', width: '20', height: '20' }),
          React.createElement('input', { type: 'text', id: 'rowsTxt', value: this.state.rows, onChange: e => this.handleTextChange(e) })
        ),
        React.createElement(
          'div',
          { className: 'property' },
          React.createElement('img', { src: 'https://cdn.rawgit.com/ofirdagan/build-your-own-react/2e8bad05/v5-examples/v5-step2-minesweeper/assets/arrowsUpDown.svg', width: '20', height: '20' }),
          React.createElement('input', { type: 'text', id: 'columnsTxt', value: this.state.columns, onChange: e => this.handleTextChange(e) })
        ),
        React.createElement(
          'div',
          { className: 'property' },
          React.createElement('img', { src: 'https://cdn.rawgit.com/ofirdagan/build-your-own-react/2e8bad05/v5-examples/v5-step2-minesweeper/assets/bomb.svg', width: '20', height: '20' }),
      ...
      React.createElement(
        ...
        React.createElement('img', { src: 'https://cdn.rawgit.com/ofirdagan/build-your-own-react/2e8bad05/v5-examples/v5-step2-minesweeper/assets/refresh-button.svg', width: '20', height: '20',
...
var t0 = performance.now();
ReactDOM.render(React.createElement(MineSweeperApp), document.getElementById('root'));
var t1 = performance.now();
